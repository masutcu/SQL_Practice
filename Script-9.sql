...
--1-Bir kütüphanedeki kitapların bilgilerini depolamak için 
--books isminde bir tablo oluşturun. 
 ...
 */
--1.yol birden fazla sorgu aynı anda çalıştırılacaksa ';' zorunludur.
...
*/
--SERIAL Unique olmayı sağlamaz. kendin istersen değer atamana engel değil. ama otomatik atamada arttırarak yapar.
...
/*
 tabloya datalarımızı ekleyelim
...
INSERT INTO students(first_name,last_name,date_of_birth,email,phone_number,gender) 
VALUES ('Jennifer', 'Adams', '1999-09-20', '', '555-8888', 'female'); --empty null değildir. kabul eder
...
INSERT INTO students(first_name,last_name,date_of_birth,email,phone_number,gender) 
VALUES ('Robert', 'White', '2003-02-14', 'robert@example.com', '555-5555', NULL); --check null kabul eder
...
--PK olduğu için id:1 olarak kabul etmez, SERIAL UNIQUE olmayı garanti etmez
...
INSERT INTO student_address (student_id, city, country) 
VALUES (17, 'London', 'UK'); 
--FOREING key null KABUL EDER, TEKRARLI KABUL EDER ANCAK PARENT TABLODA OLMAYAN (PRIMARYKEY)DEĞER KABUL ETMEZ. 
--burada 17 parent tabloda yok.
...
--9-teachers tablosu oluşturup kayıtları ekleyin
...
--ismin uzunluğuna göre azalan sıralayın, sıralama değerleride ayrı bir sutunda görüntülensin

SELECT *, LENGTH(name) AS karakter_sayisi
FROM teachers
